...
const allterraincranes = [
  "ZAT2000V", "ZAT2500V", "ZAT3000V", "ZAT3500V", "ZAT4500V"
];

const AllterraincranesPage = () => {
  ...
  const images = useStaticQuery(graphql`
    query {
      allFile(filter: { relativeDirectory: { eq: "all-terrain-cranes" } }) {
        edges {
          node {
            name
            childImageSharp {
  ...
  return (
    <Layout>
      <Header>
        <h1>Автокраны полноприводные</h1>
        <Link to="/">
          <h2>Zoomlion</h2>
        </Link>
        <ContactInfo>
...
export default AllterraincranesPage;
