...
const crawlercranes = [
  "ZCC550", "ZCC750V", "ZCC1000V", "ZCC1500V", "ZCC2000-1", "ZCC5000"
];

const CrawlercranesPage = () => {
  ...
  const images = useStaticQuery(graphql`
    query {
      allFile(filter: { relativeDirectory: { eq: "crawler-cranes" } }) {
        edges {
          node {
            name
            childImageSharp {
