...
const SkidsteerloadersPage = ({ data }) => {
  ...
  return (
    <Layout>
      <Header centerText="Мини-погрузчики" />
...
export const query = graphql`
  query {
    images: allFile(filter: { relativeDirectory: { eq: "skidsteerloaders" } }) {
      edges {
        node {
          name
          childImageSharp {
    ...
    models: allSkidsteerloadersJson {
      edges {
        node {
          modelId
          name
...
export default SkidsteerloadersPage;
