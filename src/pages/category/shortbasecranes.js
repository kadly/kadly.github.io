...
const ShortbasecranesPage = ({ data }) => {
  ...
  return (
    <Layout>
      <Header centerText="Короткобазовые краны" />
...
export const query = graphql`
  query {
    images: allFile(filter: { relativeDirectory: { eq: "shortbasecranes" } }) {
      edges {
        node {
          name
          childImageSharp {
