...
const clamshellexcavators = [
  "ZDG650"
];

const ClamshellexcavatorsPage = () => {
  ...
  const images = useStaticQuery(graphql`
    query {
      allFile(filter: { relativeDirectory: { eq: "clamshell-excavators" } }) {
        edges {
          node {
            name
            childImageSharp {
