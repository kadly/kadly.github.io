...
const AllterraincranesPage = ({ data }) => {
  ...
  return (
    <Layout>
      <Header centerText="Вездеходные краны" />
...
export const query = graphql`
  query {
    images: allFile(filter: { relativeDirectory: { eq: "allterraincranes" } }) {
      edges {
        node {
          name
          childImageSharp {
    ...
    models: allAllterraincranesJson {
      edges {
        node {
          modelId
          name
